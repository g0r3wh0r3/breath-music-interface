...
this gives values of 0.9628 pH when the band is stretched and 1.142 pH when it's relaxed. Which is insanely tiny. Decreasing the length and increasing the number of turns, so having a shorter, tigther-wound coil would help. I might try to make a tighter-wound band and test it.
